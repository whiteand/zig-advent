...
pub fn build(b: *std.Build) !void {
    ...
    const tests: []const struct {
        ...
        cmd: []const u8,
    } = &.{ .{ .filter = "part1-example", .description = "Run Part 1 Example Tests", .cmd = "test-p1-example" }, .{ .filter = "part2-example", .description = "Run Part 2 Example Tests", .cmd = "test-p2-example" }, .{ .filter = "part1-actual", .description = "Run Part 1 Actual Tests", .cmd = "test-p1" }, .{ .filter = "part2", .description = "Run Part 2 Actual Tests", .cmd = "test-p2" } };
